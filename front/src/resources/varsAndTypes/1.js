...
export const description = `<b>Zmienne</b> są specjalnym elementem języka, które pozwalają przechowywać warotści. Dzięki takiemu mechanizmowi, możliwe jest odwoływanie się do jednej wartości z wielu miejsc w kodzie bez konieczności jej ciągłego zapisywania. Główną zaletą zmiennych jest to, że pozwalają one zmienić wielokrotnie używaną wartość, poprzez modyfikację w jednym miejscu.
Proces tworzenia zmiennej składa się z dwóch etapów: <b>deklaracji</b>, gdzie określany jest typ i nazwa oraz <b>inicjalizacji</b>, gdzie nadawana jest konkretna wartość. Często również sprowadza się te dwa mechanizmy do jednej definicji zmiennej, której schemat jest następujący: 
<java>
